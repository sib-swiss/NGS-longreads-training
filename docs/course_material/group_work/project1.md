...
* Run `flair collapse` to generate isoforms from corrected reads. 
...
* Now you can do several things:
    * Do a differential expression analysis with `flair diffexp` and investigate the results. Do you find differentially expressed genes? 
    * Do you find differentially expressed isoforms?
    * Investigate the isoform usage and productivity with flair additional programs. If you pick one of the genes shown in Figure 5 from [the paper](https://link.springer.com/article/10.1186/s12864-023-09552-6), do you find the same isoforms as they do? 
    * Compare the isoforms you find for some genes with the annotation. Do you find novel isoforms?
